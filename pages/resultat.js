...
function Resultat({ images }) {
    ...
    const resultat = answers.map((answer, i) => {
        ...
        return (
            <div>
                <ResultCard key={i} isCorrect={isCorrect} src={answer.img} />
                ...
                <div className="max-w-6xl flex flex-col md:flex-row justify-between m-auto text-left px-6 xl:px-0 items-center">
                    ...
                    <div class="">
                        ...
                        <div class="sharing-buttons flex flex-wrap gap-4">
                            <a class="btn bg-[#3b5998] hover:bg-[#3b5998] text-white" target="_blank" rel="noopener" href="https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgame.all-images.ai" aria-label="Share on Facebook" draggable="false">
                            ...
                            <a class="btn bg-[#1da1f2] hover:bg-[#1da1f2] text-white"
...
#allimages  #ai #ia`)}`}
                            ...
                            <a class="btn bg-[#0e76a8] hover:bg-[#0e76a8] text-white" target="_blank" rel="noopener" href="https://linkedin.com/shareArticle?url=game.all-images.ai" aria-label="Share on Linkedin">
                                <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-6 h-6">
