                ...
                <div className="max-w-6xl flex flex-col md:flex-row justify-between m-auto text-left px-6 xl:px-0 items-center">
                        <div className="flex items-center mb-6 md:mb-0">
                            ...
                            <a target='_blank' className="ms-2" href="https://all-images.ai">
                                <img src="/logo.webp" className="h-8" alt="" />
                            </a>
                    ...
                    <div >
                        <h3 className="mb-4 text-center md:text-left">Partagez votre résultat :</h3>
                        <div className="sharing-buttons flex flex-wrap gap-4">
                            <a className="btn bg-[#3b5998] hover:bg-[#3b5998] text-white" target="_blank" rel="noopener" href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("Découvrez ce site incroyable : https://game.all-images.ai")}`} aria-label="Share on Facebook" draggable="false">
                            ...
                            <a className="btn bg-[#1da1f2] hover:bg-[#1da1f2] text-white"
...
#allimages  #ai #ia`)}`}
                            ...
                            <a className="btn bg-[#0e76a8] hover:bg-[#0e76a8] text-white" target="_blank" rel="noopener" href="https://linkedin.com/shareArticle?url=game.all-images.ai" aria-label="Share on Linkedin">
                                <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
                        ...
                        <div className="text-lg text-center md:text-end mt-6 xl:hidden">👨‍💻 par <a href="https://brice-eliasse.com" className="link link-error no-underline" target="_blank">Brice Eliasse</a></div>
                    </div>
                </div>
